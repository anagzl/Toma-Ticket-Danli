...
<body>
 ...
 -->
										...
										<a target="_blank" href="seleccionar_cr.php" data-toggle="tooltip" data-placement="top" title="Seleccionar CR"> <div class="col-6 col-sm-4"><button type="button" class="btn btn-outline-info  btn-lg login100-form-btn" style="width: 100%;" aria-placeholder="#" href="#"><img src="../../img/desing/recibo.png" height ="64" width="64" /> <P> <i class="bi bi-ticket"></i> Sistema Toma Tickets </P></button></div></a>
