<?php
    ...
    */
     ...
     */    
           ...
           if($fila["Estado"]== 1){
                    $sub_array[]='<button type="button"name="cambiar" id="'.$fila["idEmpleado"].'" class="btn btn-success borrar"><i class="bi bi-toggle-on"></i> Habilitado</button>';
                }else{
                    $sub_array[]='<button type="button"name="cambiar" id="'.$fila["idEmpleado"].'" class="btn btn-danger borrar"><i  class="bi bi-toggle-off"></i> Deshabilitado </button>';
                }  
                $datos[] = $sub_array;
